...
```{r}
pacman::p_load(tidyverse, rio, janitor, gganimate, grDevices)
```
...
cpi |> 
  ...
  labs(title = '¿Qué impulsa a la inflación?',
       subtitle = 'Mayo 2020') +
  annotation_custom(grid::textGrob('Cambio intermensual en las categorías de gasto', 
                                   x = .36, y = 1.05)) +
  annotation_custom(grid::textGrob('del índice de precios al consumidor', 
                                   x = .27, y = 1)) +
