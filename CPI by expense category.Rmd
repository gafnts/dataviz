...
#### Colores y tipografía del gráfico
...
cpi |> 
  ...
  labs(title = "¿Qué impulsa a la inflación en Guatemala?<br><br>
  ...
  theme(
    ...
    plot.subtitle = element_text(hjust = 1, 
                                 family = font,
                                 color = main),
    plot.caption = element_text(margin = unit(c(2.3, 0, 0, 0), 'line')),
...
plot <- 
  ...
  labs(title = "<b>**¿Qué impulsa a la inflación en Guatemala?**</b><br><br>
    <span style = 'font-size:12pt'>Cambio intermensual en las categorías de gasto<br>del índice de precios al consumidor</span>",
